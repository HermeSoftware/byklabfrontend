    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12" data-testid="login-page">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400 mt-2">Hesabınıza giriş yapın</p>
        </div>

        {/* Form */}
        <div className="glass rounded-2xl p-8" data-testid="login-form">
          {error && (
            <div className="mb-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20 flex items-start space-x-3" data-testid="login-error">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-400">
              Hesabınız yok mu?{' '}
              <Link to="/signup" className="text-[#0f6e32] hover:underline" data-testid="signup-link">
                Kayıt Ol
              </Link>
            </p>
          </div>
